...
// 画面内アンカースクロール(lazy対応)
  ...
  var fixbtnConf = 'fixstartOffset >= sct ';
    ...
    $(window).scroll(function() {
      ...
      if (scrollTop >= $('#top_floating_banner').height() +5) {
        $('#top_floating_banner').fadeIn('slow')
      } else if (scrollTop < $('#top_floating_banner').height() + 10){
        $('#top_floating_banner').fadeOut('slow')
      }
